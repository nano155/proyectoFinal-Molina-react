...
export const NavBar = () => {
    const {totalProducts, cart} = useContext(UserContext)
    return (
        <>
            <nav className='nav content'>
                <figure className="nav-logo">
                    <Link className='nav-link' to='/' ><img src="/src/assets/img/SB logo-1.png" alt="" /></Link>
                </figure>
                <ul className="nav-list">
                    {
                        category.map((categoria, index) => (
                            <NavLink key={index} to={`/category/${categoria.type}`}>{categoria.name}</NavLink>
                        ))
                    }
                ...
                <ul className='nav-social'>
                    <li><a href="https://api.whatsapp.com/send?phone=573043484483&text=Hola%20San%20Bife%20%F0%9F%91%8B%20quisiera%20hacer%20una%20reserva%20%F0%9F%98%8A" target='_blank   '>
                    ...
                    <li>
                        <a href="https://www.instagram.com/sanbife/" target='_blank'>
                    ...
                    <li>
                        <NavLink to='cart'>
                            <figure>
                                ...
                                {<span className={`total-product ${cart.length === 0 ? 'disabled':''}`}>{totalProducts()|| cart}</span>}
                        </NavLink>
                    </li>
                </ul>
            </nav>
